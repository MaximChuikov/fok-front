import { DecryptedObj } from "../types/response/DecryptedObjType";
...
async function decryptObject(base64: string, password: string) {
...
export async function encryptObject(obj: any, password: string): Promise<string> {
    ...
    // Convert Uint8Array to a binary string safely for btoa
